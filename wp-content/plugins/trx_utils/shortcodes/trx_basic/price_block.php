...
/* Theme setup section
-------------------------------------------------------------------- */
if (!function_exists('logistic_company_sc_price_block_theme_setup')) {
	add_action( 'logistic_company_action_before_init_theme', 'logistic_company_sc_price_block_theme_setup' );
	function logistic_company_sc_price_block_theme_setup() {
		add_action('logistic_company_action_shortcodes_list', 		'logistic_company_sc_price_block_reg_shortcodes');
		if (function_exists('logistic_company_exists_visual_composer') && logistic_company_exists_visual_composer())
			add_action('logistic_company_action_shortcodes_list_vc','logistic_company_sc_price_block_reg_shortcodes_vc');
	}
}
...
if (!function_exists('logistic_company_sc_price_block')) {	
	function logistic_company_sc_price_block($atts, $content=null){	
		...
		$content = do_shortcode(logistic_company_sc_clear_around($content));
		$output = '<div' . ($id ? ' id="'.esc_attr($id).'"' : '') 
			...
			. '</div>';
		return apply_filters('logistic_company_shortcode_output', $output, 'trx_price_block', $atts, $content);
	}
	logistic_company_require_shortcode('trx_price_block', 'logistic_company_sc_price_block');
}
...
-------------------------------------------------------------------- */
if ( !function_exists( 'logistic_company_sc_price_block_reg_shortcodes' ) ) {
	//add_action('logistic_company_action_shortcodes_list', 'logistic_company_sc_price_block_reg_shortcodes');
	function logistic_company_sc_price_block_reg_shortcodes() {
	
		logistic_company_sc_map("trx_price_block", array(
			"title" => esc_html__("Price block", 'logistic-company'),
			"desc" => wp_kses_data( __("Insert price block with title, price and description", 'logistic-company') ),
			"decorate" => false,
			"container" => true,
			"params" => array(
				"style" => array(
					"title" => esc_html__("Block style", 'logistic-company'),
					"desc" => wp_kses_data( __("Select style for this price block", 'logistic-company') ),
					"value" => 1,
					"options" => logistic_company_get_list_styles(1, 3),
					"type" => "checklist"
				),
				"title" => array(
					"title" => esc_html__("Title", 'logistic-company'),
					"desc" => wp_kses_data( __("Block title", 'logistic-company') ),
					"value" => "",
					"type" => "text"
				),
				"link" => array(
					"title" => esc_html__("Link URL", 'logistic-company'),
					"desc" => wp_kses_data( __("URL for link from button (at bottom of the block)", 'logistic-company') ),
					"value" => "",
					"type" => "text"
				),
				"link_text" => array(
					"title" => esc_html__("Link text", 'logistic-company'),
					"desc" => wp_kses_data( __("Text (caption) for the link button (at bottom of the block). If empty - button not showed", 'logistic-company') ),
					"value" => "",
					"type" => "text"
				),
				"icon" => array(
					"title" => esc_html__("Icon",  'logistic-company'),
					"desc" => wp_kses_data( __('Select icon from Fontello icons set (placed before/instead price)',  'logistic-company') ),
					"value" => "",
					"type" => "icons",
				...
				"_content_" => array(
					...
					"desc" => wp_kses_data( __("Description for this price block", 'logistic-company') ),
					"divider" => true,
					"rows" => 4,
					"value" => "",
					"type" => "textarea"
...
-------------------------------------------------------------------- */
if ( !function_exists( 'logistic_company_sc_price_block_reg_shortcodes_vc' ) ) {
	//add_action('logistic_company_action_shortcodes_list_vc', 'logistic_company_sc_price_block_reg_shortcodes_vc');
	function logistic_company_sc_price_block_reg_shortcodes_vc() {
	
		vc_map( array(
			"base" => "trx_price_block",
			"name" => esc_html__("Price block", 'logistic-company'),
			"description" => wp_kses_data( __("Insert price block with title, price and description", 'logistic-company') ),
			...
			"params" => array(
				array(
					"param_name" => "style",
					"heading" => esc_html__("Block style", 'logistic-company'),
					"desc" => wp_kses_data( __("Select style of this price block", 'logistic-company') ),
					"admin_label" => true,
					"class" => "",
					"std" => 1,
					"value" => array_flip(logistic_company_get_list_styles(1, 3)),
					"type" => "dropdown"
				),
				array(
					"param_name" => "title",
					"heading" => esc_html__("Title", 'logistic-company'),
					"description" => wp_kses_data( __("Block title", 'logistic-company') ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "textfield"
                ...
                array(
                    ...
                    "description" => wp_kses_data( __("Block subtitle", 'logistic-company') ),
                    "admin_label" => true,
                    "class" => "",
                    "value" => "",
                    "type" => "textfield"
				...
				array(
					...
					"description" => wp_kses_data( __("URL for link from button (at bottom of the block)", 'logistic-company') ),
					"class" => "",
					"value" => "",
					"type" => "textfield"
				),
				array(
					...
					"heading" => esc_html__("Link text", 'logistic-company'),
					"description" => wp_kses_data( __("Text (caption) for the link button (at bottom of the block). If empty - button not showed", 'logistic-company') ),
					"class" => "",
					"value" => "",
					"type" => "textfield"
				),
				array(
					...
					"description" => wp_kses_data( __("Select icon from Fontello icons set (placed before/instead price)", 'logistic-company') ),
					"class" => "",
				...
				array(
					...
					"admin_label" => true,
					"group" => esc_html__('Money', 'logistic-company'),
					"class" => "",
					"value" => "",
					"type" => "textfield"
				),
				...
				array(
					...
					"description" => wp_kses_data( __("Description for this price block", 'logistic-company') ),
					"class" => "",
					"value" => "",
					"type" => "textarea_html"
				),
		...
		class WPBakeryShortCode_Trx_PriceBlock extends LOGISTIC_COMPANY_VC_ShortCodeSingle {}
	}
}
?>