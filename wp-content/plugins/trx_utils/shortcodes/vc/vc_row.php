...
if (function_exists('vc_map_get_attributes')) {						// New VC
	 ...
	 * @var $scheme		- added by Logistic Company
	 * @var $inverse	- added by Logistic Company
	 * @var $atts
	 * @var $el_class
	 * @var $full_width
	 * @var $full_height
	...
	// Added by Logistic Company:
	// Color scheme
	if ($scheme && !logistic_company_param_is_off($scheme) && !logistic_company_param_is_inherit($scheme)) $css_classes[] = 'scheme_'.esc_attr($scheme);
	// Inverse colors
	if ($inverse && !logistic_company_param_is_off($inverse)) $css_classes[] = 'inverse_colors';
	...
	// Add Logistic Company color scheme in the row
	if ($scheme && !logistic_company_param_is_off($scheme) && !logistic_company_param_is_inherit($scheme)) $css_class .= ' scheme_'.esc_attr($scheme);
	...
	} ?> <?php logistic_company_show_layout($style); ?>><?php
	echo wpb_js_remove_wpautop( $content );
	?></div><?php logistic_company_show_layout($this->endBlockComment('row'));
	if ( ! empty( $full_width ) ) {
