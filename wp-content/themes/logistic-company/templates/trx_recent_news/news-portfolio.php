...
if ( !function_exists( 'logistic_company_template_news_portfolio_theme_setup' ) ) {
	add_action( 'logistic_company_action_before_init_theme', 'logistic_company_template_news_portfolio_theme_setup', 1 );
	function logistic_company_template_news_portfolio_theme_setup() {
		logistic_company_add_template(array(
			'layout' => 'news-portfolio',
			'template' => 'news-portfolio',
			'mode'   => 'news',
			'title'  => esc_html__('Recent News /Style Portfolio/', 'logistic-company'),
...
// Template output
if ( !function_exists( 'logistic_company_template_news_portfolio_output' ) ) {
	function logistic_company_template_news_portfolio_output($post_options, $post_data) {
